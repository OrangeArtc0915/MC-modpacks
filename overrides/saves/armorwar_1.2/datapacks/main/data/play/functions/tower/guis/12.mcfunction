...
execute if score tower_16 int matches 1 unless data entity @s Inventory[{Slot:3b}].tag{tower:soldier3} run scoreboard players set temp int 1
...
execute if score temp int matches 1 run function play:tower/items/12