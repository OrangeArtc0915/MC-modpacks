...
data modify block 0 0 0 Items[0].tag.ctmp set value {spec:["build_model","phb_visible1"],int:1,soldier_sort:1,at:14.0,at_cd:8,type:"soldier_1",health:1600,mhp:1600,sp:50,hand0:2,hand1:0,head:1,chest:3,leg:3,foot:4,spawn:{pos:[],rotation:[]}}
...
execute if data entity @s SelectedItem.tag.skill_0 run scoreboard players set @s CD0 45
execute if data entity @s SelectedItem.tag.skill_1 run scoreboard players set @s CD1 45
execute if data entity @s SelectedItem.tag.skill_2 run scoreboard players set @s CD2 45