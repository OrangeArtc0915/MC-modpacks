clear @s
execute if score tower_10 int matches 1 run replaceitem entity @s hotbar.3 carrot_on_a_stick{CustomModelData:8592002,display:{Lore:['{"text":"§7按Q建造"}','{"text":"§7爆炸中心§c1250/次"}','{"text":"§7冷却:§e2.0秒§7或更少"}','{"text":"§7攻击范围:§b24.5格"}'],Name:'[{"text":"§c炮塔-"},{"text":" §6288金币"}]'},tdisplay:2b,build:10,tower:gun2,ui:1b}
