...
scoreboard players operation temp int *= 180 int
...
execute store result entity @e[tag=tmp1,limit=1] ArmorItems[3].tag.pofs[0][0] double 0.001 run scoreboard players operation target_x shthVar += tempx int
execute store result entity @e[tag=tmp1,limit=1] ArmorItems[3].tag.pofs[0][1] double 0.001 run scoreboard players operation target_y shthVar += tempy int
execute store result entity @e[tag=tmp1,limit=1] ArmorItems[3].tag.pofs[0][2] double 0.001 run scoreboard players operation target_z shthVar += tempz int
