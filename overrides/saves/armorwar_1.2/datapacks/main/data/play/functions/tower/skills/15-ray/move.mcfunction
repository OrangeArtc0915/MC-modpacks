...
scoreboard players operation u int /= 1000000 int

scoreboard players operation x int = p0 int
scoreboard players operation temp int = u0 int
scoreboard players operation temp int *= u int
scoreboard players operation temp int /= 1000 int
...
scoreboard players operation temp int = u2 int
scoreboard players operation temp int *= u int
scoreboard players operation temp int /= 1000 int
...
execute if score v int < t int run function play:tower/skills/15-ray/move