scoreboard players remove @s dattack 1
execute store result entity @s Pos[0] double 0.001 run scoreboard players get @s dax
execute store result entity @s Pos[2] double 0.001 run scoreboard players get @s daz
execute if score @s dattack matches ..0 run tag @s remove attacking2
execute if score @s dattack matches ..0 run tag @s remove attacking
