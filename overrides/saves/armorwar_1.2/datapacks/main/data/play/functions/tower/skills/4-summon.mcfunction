...
#生成士兵
data modify block 0 0 0 Items[0].tag.ctmp set value {spec:["build_model","phb_visible1"],int:1,soldier_sort:1,at:5.0,at_cd:16,dp:15.0f,type:"soldier_0",health:70,mhp:70,sp:40,hand0:2,hand1:25,head:3,chest:3,leg:1,foot:1,spawn:{pos:[],rotation:[]}}
