...
execute as @e[tag=tmp2,limit=1] at @s if block ~ ~0.3 ~ #minecraft:slabs run tp @s ~ ~0.54 ~
...
execute positioned ^ ^ ^0.1 run summon area_effect_cloud ~ ~ ~ {Tags:["arrow0","arrow5","tmp9"],Duration:8}
