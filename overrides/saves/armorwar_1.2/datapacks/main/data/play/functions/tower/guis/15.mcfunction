...
execute unless data entity @s Inventory[{Slot:2b}].tag{tower_skill:magic3_0} run scoreboard players set temp int 1
execute unless data entity @s Inventory[{Slot:3b}].tag{tower_skill:magic3_1} run scoreboard players set temp int 1
...
execute if score temp int matches 1 run function play:tower/items/15