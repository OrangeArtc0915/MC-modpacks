clear @s
execute if score tower_7 int matches 1 run replaceitem entity @s hotbar.3 carrot_on_a_stick{CustomModelData:8592003,display:{Lore:['{"text":"§7按Q建造"}','{"text":"§7魔法伤害:§c11/刻"}','{"text":"§7冷却:§e1.0秒§7或更少"}','{"text":"§7攻击范围:§b19.5格"}'],Name:'[{"text":"§c魔法塔-"},{"text":" §6144金币"}]'},tdisplay:2b,build:7,tower:magic1,ui:1b}
