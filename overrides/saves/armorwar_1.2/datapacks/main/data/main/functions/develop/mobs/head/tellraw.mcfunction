...
#减10并保证不为负
execute at @e[tag=tmp,limit=1] run data modify entity @e[tag=tmp,limit=1] Item.tag.result.entity.headitem set from entity @p SelectedItem
data modify entity @e[tag=tmp,limit=1] Item.tag.result.entity.headitem.Slot set value 103b
