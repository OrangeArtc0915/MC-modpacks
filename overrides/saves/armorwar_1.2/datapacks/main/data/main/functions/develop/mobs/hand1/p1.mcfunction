...
execute if score temp int matches 38.. run scoreboard players set temp int 0
execute store result entity @e[tag=tmp,limit=1] Item.tag.result.entity.hand1 float 1 run scoreboard players get temp int
