...
execute as @e[tag=tmp] run function list_tool:set
data remove entity @e[tag=tmp,limit=1] Item.tag.result.entity.spawn.pos
data remove entity @e[tag=tmp,limit=1] Item.tag.result.entity.spawn.poses
data remove entity @e[tag=tmp,limit=1] Item.tag.result.entity.spawn.paths
