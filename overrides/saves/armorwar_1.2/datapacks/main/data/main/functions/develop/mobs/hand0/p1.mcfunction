...
execute if score temp int matches 37.. run scoreboard players set temp int 0
execute store result entity @e[tag=tmp,limit=1] Item.tag.result.entity.hand0 float 1 run scoreboard players get temp int
