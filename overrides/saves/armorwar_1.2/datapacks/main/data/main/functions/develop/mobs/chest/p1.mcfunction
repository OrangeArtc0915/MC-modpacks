...
execute if score temp int matches 7.. run scoreboard players set temp int 0
execute store result entity @e[tag=tmp,limit=1] Item.tag.result.entity.chest float 1 run scoreboard players get temp int
