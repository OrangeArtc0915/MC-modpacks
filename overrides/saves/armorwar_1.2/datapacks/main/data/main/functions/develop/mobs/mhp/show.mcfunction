...
#输出
setblock 0 10 0 air
setblock 0 10 0 oak_sign{Text1:'{"nbt":"Item.tag.result.entity.mhp","entity":"@e[tag=tmp,limit=1]"}'}
execute as @e[tag=mhp_show] run data modify entity @s CustomName set from block 0 10 0 Text1
