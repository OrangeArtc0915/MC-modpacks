...
summon item 0.0 11.0 0.0 {Tags:["scheduler.item","tmp"],Item:{id:"minecraft:glass",Count:1b,tag:{time:2,uuid:[],command:"execute as @a[tag=scheduler.mark] run function tree:enter"}}}
