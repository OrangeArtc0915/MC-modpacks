...
#波
execute as @e[tag=mpar_wave] run function math:particles/wave
...
execute at @e[tag=!mpar_air,tag=mpar_green_dust] run particle dust 0.001 0.5 0.0 0.8 ~ ~ ~ 0.0 0.0 0.0 0 1 force
