...
execute if score @s list_input matches 0.. as @s at @s run function list_tool:set_pos
execute if score @s list_input matches ..-1 as @s at @s run function list_tool:set_neg
