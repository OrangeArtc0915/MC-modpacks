...
execute if score @s list_input matches 0.. run function list_tool:remove_neg_again
execute unless score @s list_input matches 0.. run function list_tool:remove_neg