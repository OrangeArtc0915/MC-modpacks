execute store result score #temp psp_id1 run scoreboard players operation #temp psp_id0 = #id psp_id
...
data modify storage psp:result person merge from storage psp:all temp[0]